...
public class RegistrationService {
    ...
    public void register(@Header("dateTime") OffsetDateTime dateTime,
        ...
        TicketPrice ticketPrice = getTicketPrice(registration, dateTime);
    ...
    private TicketPrice getTicketPrice(AttendeeRegistration registration, OffsetDateTime dateTime) {
